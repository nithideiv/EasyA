...
Authors: Simone Badaruddin, Nithi Deivanayagam, Luke Marshall

This module contains the tkinter interface for the Group 3 CS422 EasyA group project.
The interface includes several dropdown menus:
Course dropdown: allows a user to choose one of any of the courses in the grade data
that are in the natural science departments; a choice of class supersedes any other dichotomous
...
grade dropdown: allows users to choose if they would like the grade data to be displayed in terms of 
%As, or %Ds and Fs; default is in %As
faculty dropdown: allows users to determine if they would like the grade data to be displayed for all
...
One of 4 grapher subclasses is instantiated based on the dropdowns that were used, and the arguments
