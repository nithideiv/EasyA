...
Contains: 
Grapher abstract base class: For creating a template for its subclasses, passing down methods and attributes
...
Subjs_And_Level_By_Prof_Grapher: for graphing individual subjects and level according to instructors
Subjs_And_Level_By_Class_Grapher: for graphing individual subjects and level according to class
